...
export default function KoszulaPage() {
  ...
  const goPrev = useCallback(() => {
    setLightboxIndex((i) =>
      i === null ? null : (i - 1 + KOSZULA.length) % KOSZULA.length
    );
  }, []);

  const goNext = useCallback(() => {
    setLightboxIndex((i) =>
      i === null ? null : (i + 1) % KOSZULA.length
    );
  }, []);
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <TwoToneHeading as="h1" className="text-3xl md:text-5xl font-black mb-4">
              <AnimateText k="productNames.koszula" />
            </TwoToneHeading>
      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          >
            <Image
              src={KOSZULA[lightboxIndex].src}
              alt={KOSZULA[lightboxIndex].name}
              fill
              sizes="90vw"
