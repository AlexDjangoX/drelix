...
export default function SpodniePage() {
  ...
  const goPrev = useCallback(() => {
    setLightboxIndex((i) =>
      i === null ? null : (i - 1 + SPODNIE.length) % SPODNIE.length
    );
  }, []);

  const goNext = useCallback(() => {
    setLightboxIndex((i) =>
      i === null ? null : (i + 1) % SPODNIE.length
    );
  }, []);
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <TwoToneHeading as="h1" className="text-3xl md:text-5xl font-black mb-4">
              <AnimateText k="productNames.clothing" />
            </TwoToneHeading>
      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          >
            <Image
              src={SPODNIE[lightboxIndex].src}
              alt={SPODNIE[lightboxIndex].name}
              fill
              sizes="90vw"
