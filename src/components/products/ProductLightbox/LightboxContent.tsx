...
export function LightboxContent({
  ...
  const imageLoaded = loadedSrc === largeSrc;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden pt-8 pb-4 px-5 bg-background text-foreground">
          {description ? (
            <div
